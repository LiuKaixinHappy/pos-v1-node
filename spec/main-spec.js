...
describe('pos', function () {
    ...
    it('should get result after discount', function () {
        let items_and_count = main.get_items_and_count(inputs);
        let items_info = main.get_items_info(items_and_count);
        let result_after_discount = main.get_buy_two_one_free(items_info);
        let expected = [
            {
                barcode: 'ITEM000001',
                name: '雪碧',
        ...
        expect(result_after_discount).toEqual(expected);
    });
